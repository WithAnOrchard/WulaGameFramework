...
#pragma warning disable 0414
    public class DesktopWindow : MonoBehaviour
    {
        ...
        private void ApplyDesktopWindow()
        {
            ...
            // 3) DWM 玻璃帧：按 backbuffer per-pixel alpha 合成（不调 SetLayeredWindowAttributes，会冲掉 DWM 路径）
            ...
            // 4) 撑满主屏 WorkArea（Win32 先 resize，再让 Unity 端 SetResolution 跟上）
