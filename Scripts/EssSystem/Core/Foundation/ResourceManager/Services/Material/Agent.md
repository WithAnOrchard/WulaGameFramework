...
## 职责
- 负责 Material 异步加载和资源缓存登记。
- 模块路径：`Scripts/EssSystem/Core/Foundation/ResourceManager/Services/Material`。
...
## Event API
- `MaterialService.EVT_GET_MATERIAL_ASYNC` = `"GetMaterialAsync"`
- `MaterialService.EVT_LOAD_MATERIAL_ASYNC` = `"LoadMaterialAsync"`
