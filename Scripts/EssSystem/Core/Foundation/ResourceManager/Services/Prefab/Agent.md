...
## 职责
- 负责 GameObject/Prefab 异步加载和资源缓存登记。
- 模块路径：`Scripts/EssSystem/Core/Foundation/ResourceManager/Services/Prefab`。
...
## Event API
- `PrefabService.EVT_GET_PREFAB_ASYNC` = `"GetPrefabAsync"`
- `PrefabService.EVT_LOAD_PREFAB_ASYNC` = `"LoadPrefabAsync"`
