...
## 职责
- 负责 Texture2D 异步加载和资源缓存登记。
- 模块路径：`Scripts/EssSystem/Core/Foundation/ResourceManager/Services/Texture`。
...
## Event API
- `TextureService.EVT_GET_TEXTURE_ASYNC` = `"GetTextureAsync"`
- `TextureService.EVT_LOAD_TEXTURE_ASYNC` = `"LoadTextureAsync"`
