...
## 职责
- 负责 AudioClip 异步加载和资源缓存登记。
- 模块路径：`Scripts/EssSystem/Core/Foundation/ResourceManager/Services/Audio`。
...
## Event API
- `AudioClipService.EVT_GET_AUDIO_CLIP_ASYNC` = `"GetAudioClipAsync"`
- `AudioClipService.EVT_LOAD_AUDIO_CLIP_ASYNC` = `"LoadAudioClipAsync"`
