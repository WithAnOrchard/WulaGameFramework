...
namespace EssSystem.EssManager.MapManager.Dao
{
    ...
    public class Chunk
    {
        ...
        public void ApplyOverrides(IList<EssSystem.EssManager.MapManager.Persistence.Dao.TileOverride> overrides)
        {
        ...
        /// </summary>
        public List<EssSystem.EssManager.MapManager.Persistence.Dao.TileOverride> EnumerateOverrides()
        {
            var list = new List<EssSystem.EssManager.MapManager.Persistence.Dao.TileOverride>(
