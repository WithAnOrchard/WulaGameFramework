...
using EssSystem.EssManager.MapManager.Dao.Templates.SideScrollerRandom.Generator;
using UnityEngine;

namespace EssSystem.EssManager.MapManager.Dao.Templates.SideScrollerRandom.Config
{
    /// <summary>
    /// 横版 2D 随机大世界配置（骨架）。
    /// <para>
