...
namespace EssSystem.Core.EssManagers.Gameplay.CharacterManager.EditorTools
{
    ...
    /// <para>用途：在 <see cref="EssSystem.Core.EssManagers.Gameplay.CharacterManager.Dao.CharacterRenderMode.Prefab3D"/>
    /// 模式下省去手动建 Controller。Playables 模式（<see cref="EssSystem.Core.EssManagers.Gameplay.CharacterManager.Dao.CharacterRenderMode.Prefab3DClips"/>）不需要本工具。</para>
