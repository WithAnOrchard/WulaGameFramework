...
using EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Dao.Templates.TopDownRandom.Config;
using EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Dao.Templates.TopDownRandom.Dao;
using UnityEngine;

namespace EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Dao.Templates.TopDownRandom.Generator
{
    public static class RiverTracer
    {
        ...
        {
            return typeId == TopDownTileTypes.DeepOcean || typeId == EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Dao.TileTypes.Ocean || typeId == TopDownTileTypes.ShallowOcean;
        }
