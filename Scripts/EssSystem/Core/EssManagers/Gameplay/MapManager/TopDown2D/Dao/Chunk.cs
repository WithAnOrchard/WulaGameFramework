...
namespace EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Dao
{
    ...
    public class Chunk
    {
        ...
        public void ApplyOverrides(IList<EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Persistence.Dao.TileOverride> overrides)
        {
        ...
        /// </summary>
        public List<EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Persistence.Dao.TileOverride> EnumerateOverrides()
        {
            var list = new List<EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Persistence.Dao.TileOverride>(
