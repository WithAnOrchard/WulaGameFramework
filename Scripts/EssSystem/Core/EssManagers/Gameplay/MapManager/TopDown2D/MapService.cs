...
using EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Persistence;
using EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Persistence.Dao;
using EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D.Runtime;
...
namespace EssSystem.Core.EssManagers.Gameplay.MapManager.TopDown2D
{
    ...
    /// <item>对外接口以纯 C# API 暴露；如需跨模块调度，再按需在方法上加 <c>Event</c> 特性</item>
    /// </list>
    /// </summary>
