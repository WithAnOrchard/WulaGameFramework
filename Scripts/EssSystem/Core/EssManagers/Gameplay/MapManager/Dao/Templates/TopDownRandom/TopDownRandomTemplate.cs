...
using PerlinMapConfig = EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.TopDownRandom.Config.PerlinMapConfig;

namespace EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.TopDownRandom
{
    /// <summary>
