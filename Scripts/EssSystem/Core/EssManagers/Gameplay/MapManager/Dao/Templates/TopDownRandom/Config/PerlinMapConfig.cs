...
using EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.TopDownRandom.Generator;
using UnityEngine;

namespace EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.TopDownRandom.Config
{
    /// <summary>
