...
using EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.SideScrollerRandom.Config;
using EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.SideScrollerRandom.Dao;
using UnityEngine;

namespace EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.SideScrollerRandom.Generator
{
    /// <summary>
