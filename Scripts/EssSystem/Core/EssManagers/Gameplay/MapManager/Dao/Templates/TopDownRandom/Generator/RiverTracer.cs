...
using EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.TopDownRandom.Config;
using EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.TopDownRandom.Dao;
using UnityEngine;

namespace EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.TopDownRandom.Generator
{
    public static class RiverTracer
    {
        ...
        {
            return typeId == TopDownTileTypes.DeepOcean || typeId == EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.TileTypes.Ocean || typeId == TopDownTileTypes.ShallowOcean;
        }
