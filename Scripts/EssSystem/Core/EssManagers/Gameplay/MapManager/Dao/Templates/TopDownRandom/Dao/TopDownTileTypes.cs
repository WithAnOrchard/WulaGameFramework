namespace EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.Templates.TopDownRandom.Dao
{
    /// <summary>
    /// 俯视 2D（top-down）模板专用 TileType ID 常量。
    /// <para>
    /// 不再放在通用 <see cref="EssSystem.Core.EssManagers.Gameplay.MapManager.Dao.TileTypes"/>，
