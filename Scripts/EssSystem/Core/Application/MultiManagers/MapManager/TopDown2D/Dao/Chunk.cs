...
namespace EssSystem.Core.Application.MultiManagers.MapManager.TopDown2D.Dao
{
    ...
    public class Chunk
    {
        ...
        public void ApplyOverrides(IList<EssSystem.Core.Application.MultiManagers.MapManager.TopDown2D.Persistence.Dao.TileOverride> overrides)
        {
        ...
        /// </summary>
        public List<EssSystem.Core.Application.MultiManagers.MapManager.TopDown2D.Persistence.Dao.TileOverride> EnumerateOverrides()
        {
            var list = new List<EssSystem.Core.Application.MultiManagers.MapManager.TopDown2D.Persistence.Dao.TileOverride>(
