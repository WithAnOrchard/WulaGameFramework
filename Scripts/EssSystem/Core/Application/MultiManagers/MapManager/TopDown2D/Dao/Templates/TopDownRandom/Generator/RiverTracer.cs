...
namespace EssSystem.Core.Application.MultiManagers.MapManager.TopDown2D.Dao.Templates.TopDownRandom.Generator
{
    public static class RiverTracer
    {
        ...
        {
            return typeId == TopDownTileTypes.DeepOcean || typeId == EssSystem.Core.Application.MultiManagers.MapManager.TopDown2D.Dao.TileTypes.Ocean || typeId == TopDownTileTypes.ShallowOcean;
        }
