...
namespace EssSystem.Core.Application.MultiManagers.MapManager.TopDown2D.Runtime
{
    /// <summary>
    ...
    public class MapView : MonoBehaviour
    {
        ...
        {
            if (UnityEngine.Application.isPlaying && _lastValidatedMode != _debugColorMode)
            {
