...
using EssSystem.Core.Application.SingleManagers.EntityManager;            // CharacterViewBridge 仅作为 typed event wrapper 引入
using EssSystem.Core.Application.SingleManagers.EntityManager.Dao;        // Entity / EntityKind 作为 DTO
using EssSystem.Core.Application.SingleManagers.EntityManager.Dao.Config; // EntityConfig / EntityColliderConfig / EntityColliderShape 作为 DTO
using EssSystem.Core.Application.SingleManagers.EntityManager.Runtime;    // EntityHandle 仅用于 Unbind 调用
