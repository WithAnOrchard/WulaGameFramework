...
#pragma warning restore CS0618 // 类型或成员已过时
        ...
        /// </summary>
        /// <summary>
        /// 原始解析后的 JSON 节点（<see cref="JsonNode"/>，兼容链式 <c>["key"]</c> / <c>[0]</c> / <c>.ToObject&lt;T&gt;()</c> 访问）。
        /// </summary>
        public JsonNode RawDataJToken { get; set; }
    }
}