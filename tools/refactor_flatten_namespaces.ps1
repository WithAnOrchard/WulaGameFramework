# Phase B: replace 3 namespace prefixes after flattening EssManagers/.
$ErrorActionPreference = 'Stop'

$replacements = [System.Collections.ArrayList]@()
[void]$replacements.Add(@('EssSystem.Core.EssManagers.Foundation',   'EssSystem.Core.Foundation'))
[void]$replacements.Add(@('EssSystem.Core.EssManagers.Presentation', 'EssSystem.Core.Presentation'))
[void]$replacements.Add(@('EssSystem.Core.EssManagers.Gameplay',     'EssSystem.Core.Gameplay'))
